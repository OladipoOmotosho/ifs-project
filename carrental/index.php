...
<section id="banner" class="banner-section">
  <!-- <img src="../carrental/assets/images/banner.jpg" alt="" srcset="" style="width:100%;height:auto; margin-top:30px;"> -->
  <div class="container">
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center" style="color:#fff;">
      <h2 style="color:#fafafa;">Find the Best <span>CarForYou</span></h2>
    <p>Choose from a range of car models and prices to suit your needs Think Small Think Big...We've Got You Covered 
JejeRide If only everything in life was as reliable as a JejeRide For the love of the car Small wonder Try JejeRide</p>
    </div>
    <div class="row"> 
